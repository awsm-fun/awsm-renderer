...
| `set_physics_params` | `set_physics_params` | tool | Collider contact params: universal core + optional `mujoco` extension block. Whole-value replace; omit `params` to clear. |
