...
use crate::prelude::*;
use crate::scene::types::{AssetStatus, LightConfig, LightKind, NodeKind, Trs};
...
impl Node {
    ...
    pub fn new_collision_box(name: impl Into<String>) -> Arc<Self> {
        Self::new_inner(
            name,
            NodeKind::Collider(crate::scene::types::ColliderShape::default_box()),
        )
    }
    ...
    pub fn new_collision_sphere(name: impl Into<String>) -> Arc<Self> {
        Self::new_inner(
            name,
            NodeKind::Collider(crate::scene::types::ColliderShape::default_sphere()),
        )
    }
    ...
    pub fn new_collision_capsule(name: impl Into<String>) -> Arc<Self> {
        Self::new_inner(
            name,
            NodeKind::Collider(crate::scene::types::ColliderShape::default_capsule()),
        )
    }
    ...
    pub fn new_collision_cylinder(name: impl Into<String>) -> Arc<Self> {
        Self::new_inner(
            name,
            NodeKind::Collider(crate::scene::types::ColliderShape::default_cylinder()),
        )
    }
    ...
    pub fn new_collision_cone(name: impl Into<String>) -> Arc<Self> {
        Self::new_inner(
            name,
            NodeKind::Collider(crate::scene::types::ColliderShape::default_cone()),
        )
    }
    ...
    pub fn new_collision_ellipsoid(name: impl Into<String>) -> Arc<Self> {
        Self::new_inner(
            name,
            NodeKind::Collider(crate::scene::types::ColliderShape::default_ellipsoid()),
        )
    }
    ...
    pub fn new_camera(name: impl Into<String>) -> Arc<Self> {
        Self::new_inner(
            name,
            NodeKind::Camera(crate::scene::types::CameraConfig::default_perspective()),
        )
    }
