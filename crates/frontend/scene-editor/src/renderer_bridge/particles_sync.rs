...
fn build_runtime(
    ...
    let material_key = renderer
        .materials
        .insert(Material::Pbr(Box::new(pbr_opaque)), &renderer.textures, &renderer.dynamic_materials, &renderer.extras_pool);
...
async fn build_runtime_blend(
    ...
    let material_key = renderer
        .materials
        .insert(Material::Pbr(Box::new(pbr_blend)), &renderer.textures, &renderer.dynamic_materials, &renderer.extras_pool);
