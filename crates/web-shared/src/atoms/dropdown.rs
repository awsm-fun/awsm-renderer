...
/// Boxed callback fired when the user changes the dropdown's selected
/// value. Aliased so the [`Dropdown`] field doesn't trip
/// `clippy::type_complexity`.
pub type DropdownOnChange<T> = Arc<dyn Fn(&T)>;
...
pub struct Dropdown<T> {
    ...
    pub on_change: Option<DropdownOnChange<T>>,
}
        ...
        html!("div", {
            ...
            .child(html!("div", {
                ...
                .with_node!(trigger_el => {
                        ...
                        .event(clone!(showing, trigger_el => move |_: events::Click| {
