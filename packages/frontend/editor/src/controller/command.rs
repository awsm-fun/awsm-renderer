...
//!
//! The types now live in the shared [`awsm_renderer_editor_protocol`] crate (so the
...
//! [`super::state`].
pub use awsm_renderer_editor_protocol::{CameraAxis, EditorCommand, EditorMode, ProceduralKind};
