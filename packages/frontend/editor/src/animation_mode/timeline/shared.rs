//! Shared timeline geometry + track-target labelling used across the dock's
//! three views (Dope · Curves · Mixer) so their ruler / playhead / column widths
//! line up. Re-exported from the timeline module.
...
// ── track-target → label/icon/suffix (shared with the inspector) ─────────────
