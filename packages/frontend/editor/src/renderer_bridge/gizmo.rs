//! On-canvas transform gizmo, backed by `awsm_web_shared::viewport3d::TransformController`.
//!
...
use awsm_web_shared::viewport3d::transform_controller::{GizmoSpace, TransformController};
...
async fn sync_gizmo_selection(id: Option<NodeId>) {
    use awsm_web_shared::viewport3d::transform_controller::TransformObject;
    let state = app_state();
